...
# Indique à Django que le vrai protocole est dans l'en-tête X-Forwarded-Proto
# (envoyé par Nginx). Permet de générer des URLs https:// pour les fichiers media.
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@webmase.com')
